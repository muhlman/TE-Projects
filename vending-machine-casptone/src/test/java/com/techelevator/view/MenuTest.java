...
public class MenuTest {
	...
	public void displays_a_list_of_menu_options_and_prompts_user_to_make_a_choice() {
		...
		String expected = newLine + "1) " + options[0].toString() + newLine + "2) " + options[1].toString() + newLine + "3) "
				+ options[2].toString() + newLine + newLine + "Please choose an option >>> " + newLine;
	...
	public void redisplays_menu_if_user_does_not_choose_valid_option() {
		...
		String menuDisplay = newLine + "1) " + options[0].toString() + newLine + "2) " + options[1].toString() + newLine + "3) "
				+ options[2].toString() + newLine + newLine + "Please choose an option >>> " + newLine;

		String expected = menuDisplay + newLine + "*** 4 is not a valid option ***" + newLine + newLine + menuDisplay;
	...
	public void redisplays_menu_if_user_chooses_option_less_than_1() {
		...
		String expected = menuDisplay + newLine + "*** 0 is not a valid option ***" + newLine + newLine + menuDisplay;
	...
	public void redisplays_menu_if_user_enters_garbage() {
		...
		String expected = menuDisplay + newLine + "*** Mickey Mouse is not a valid option ***" + newLine + newLine + menuDisplay;
